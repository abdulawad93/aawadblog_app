...
<p>
Moreover, in validatePassword method some arrays, including lowercaseLetters,uppercaseLetters,specialCharacters,numberCharacters, unallowedCharacters, get defined and filled with integer numbers that is mapped to characters, using fromCharCode method, based on the ASCII table shown in figure x.2.</br>
